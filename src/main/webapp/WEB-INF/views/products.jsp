			...
			<form method="POST" enctype="multipart/form-data">
				...
				<div class="modal-body">
					<div class="form-row">
						<div class="col-sm-6">
							<div class="form-group">
								<label>Gift Name</label> <input type="text" name="pname"
									class="form-control">
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label>Gift Brand</label> <input type="text" name="company"
									class="form-control">
							</div>
						</div>
					</div>
					...
					<div class="form-row">
						...
						<div class="col-sm-6">
							<div class="form-group">
								<label>Gift Category</label> <select name="catid" required
									class="form-control">
